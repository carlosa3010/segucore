        ...
        @method('PUT') <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="code" required maxlength="3" 
                       class="form-input uppercase font-mono text-xl bg-gray-800 text-gray-300" 
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <input type="color" name="color_hex" 
                           ...
                           value="{{ old('color_hex', $siaCode->color_hex) }}">
                    <span class="text-xs text-gray-500">Clic para cambiar</span>
                </div>
                @error('color_hex') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <select name="sound_alert" class="form-input">
                    ...
                    <option value="panic.mp3" {{ $siaCode->sound_alert == 'panic.mp3' ? 'selected' : '' }}>panic.mp3 (Sirena Policial)</option>
                    <option value="fire_alarm.mp3" {{ $siaCode->sound_alert == 'fire_alarm.mp3' ? 'selected' : '' }}>fire_alarm.mp3 (Incendio)</option>
                    <option value="burglar.mp3" {{ $siaCode->sound_alert == 'burglar.mp3' ? 'selected' : '' }}>burglar.mp3 (Intrusión)</option>
                    <option value="warning.mp3" {{ $siaCode->sound_alert == 'warning.mp3' ? 'selected' : '' }}>warning.mp3 (Sonar/Beep)</option>
                    <option value="tamper.mp3" {{ $siaCode->sound_alert == 'tamper.mp3' ? 'selected' : '' }}>tamper.mp3 (Fallo Técnico)</option>
                </select>
            </div>
        </div>
